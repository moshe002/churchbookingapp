const BodyText = () => {
    return (
        <div className="flex flex-col justify-center items-center text-center mt-10 p-10 border-t-4 border-b-4 w-full">
                ...
                <p className="mt-5 w-3/5 text-center text-lg">
                ...
                <p className="mt-10 w-3/5 text-center text-lg">
